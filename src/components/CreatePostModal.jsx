...
/**
 * CreatePostModal — floating modal for posting achievements.
 */
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g., Won Smart India Hackathon" required
                    ...
                    <div>
                        ...
                        <select
                            name="achievementType" value={form.achievementType} onChange={handleChange}
                            className="input-field focus:input-field-focus"
                        >
